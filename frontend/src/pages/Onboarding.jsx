          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-slate-200 bg-slate-50 rounded-xl text-slate-800
                placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition text-sm"
            />
          </div>
        </div>
...
export default function Onboarding() {
  ...
  const handleFinish = () => {
    // Persist onboarding completion so we never show it again
    completeOnboarding({
